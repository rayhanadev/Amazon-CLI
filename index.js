...
var varCountry = {
	key: 'GB',
	value: { name: 'United Kingdom', currency: 'GBP' }
};
var varCategory = {
	key: 'aps',
	value: { name: 'All Departments', category: 'aps' }
};
...
let categories = [
	{ key: 'aps', value: { name: 'All Departments', category: 'aps' } },
	{
	...
	},
	{
		...
		value: { name: 'Books', category: 'stripbooks-intl-ship' }
	},
	{
	...
	{
		key: 'digital-music',
		value: { name: 'Digital Music', category: 'digital-music' }
	},
	{
	...
	{
		key: 'digital-text',
		value: { name: 'Kindle Store', category: 'digital-text' }
	},
	{
		key: 'instant-video',
		value: { name: 'Prime Video', category: 'instant-video' }
	},
	{
	...
	{
		key: 'deals-intl-ship',
		value: { name: 'Deals', category: 'deals-intl-ship' }
	},
	{
		key: 'hpc-intl-ship',
		value: { name: 'Health & Household', category: 'hpc-intl-ship' }
	},
	{
	...
	},
	{
		...
		value: { name: 'Luggage', category: 'luggage-intl-ship' }
	},
	{
	...
	{
		key: 'pets-intl-ship',
		value: { name: 'Pet Supplies', category: 'pets-intl-ship' }
	},
	{
		key: 'software-intl-ship',
		value: { name: 'Software', category: 'software-intl-ship' }
	},
	{
...
let countries = [
	...
	{ key: 'AU', value: { name: 'Australia', currency: 'AUD' } },
	{ key: 'BR', value: { name: 'Brazil', currency: 'BRL' } },
	{ key: 'CA', value: { name: 'Canada', currency: 'CAD' } },
	{ key: 'CN', value: { name: 'China', currency: 'CNY' } },
	{ key: 'FR', value: { name: 'France', currency: 'EUR' } },
	{ key: 'DE', value: { name: 'Germany', currency: 'EUR' } },
	{ key: 'IN', value: { name: 'India', currency: 'INR' } },
	{ key: 'IT', value: { name: 'Italy', currency: 'EUR' } },
	{ key: 'MX', value: { name: 'Mexico', currency: 'MXN' } },
	{ key: 'NL', value: { name: 'Netherlands', currency: 'EUR' } },
	{ key: 'SG', value: { name: 'Singapore', currency: 'SGD' } },
	{ key: 'ES', value: { name: 'Spain', currency: 'EUR' } },
	{ key: 'TR', value: { name: 'Turkey', currency: 'TRY' } },
	{ key: 'AE', value: { name: 'United Arab Emirates', currency: 'AED' } },
	{ key: 'GB', value: { name: 'United Kingdom', currency: 'GBP' } },
	{ key: 'JP', value: { name: 'Japan', currency: 'JPY' } }
];
...
let viewCountries = function() {
	...
	let countryArr = [];
	for (i = 0; i < countries.length; i++) {
		countryArr.push({ name: countries[i].value.name, key: countries[i].key });
	}
